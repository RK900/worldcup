// Generated by scripts/parse-third-place.mjs from the Wikipedia
// template "Template:2026 FIFA World Cup third-place table",
// which mirrors FIFA Annex C. Do not edit by hand — regenerate
// if FIFA ever updates the table.
//
// Key: 8 advancing groups concatenated in sorted order (e.g. "ABCDEFGH").
// Value: tuple of 8 group letters indexed by our internal slot order
//        [M74, M77, M79, M80, M81, M82, M85, M87].

import type { GroupLetter } from "@/lib/types";

export type ThirdPlaceAssignment = [
  GroupLetter, GroupLetter, GroupLetter, GroupLetter,
  GroupLetter, GroupLetter, GroupLetter, GroupLetter,
];
